package com.zgy.study.chapter06.subject09.demo03.config;

import com.zgy.study.chapter06.subject09.demo03.dao.SingerDao;
import com.zgy.study.chapter06.subject09.demo03.dao.impl.JdbcSingerDao;
...
public class EmbeddedJdbcConfig {
    ...
    public DataSource dataSource() {
        ...
        return builder.setType(EmbeddedDatabaseType.H2)
                .addScripts("classpath:subject09/demo03/db/h2/schema.sql",
                        "classpath:subject09/demo03/db/h2/test-data.sql")
                .build();
    }
